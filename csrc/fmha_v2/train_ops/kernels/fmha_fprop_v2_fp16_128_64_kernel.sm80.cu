...
using Kernel_traits =
    fmha::Kernel_traits_v2<fmha::Ampere_hmma_fp32_traits, 128, 64, 16, 1, 4, 1, 0x20u>;

template <bool IS_TRAINING>
__global__ void fmha_fprop_v2_fp16_128_64_sm80_kernel(Fused_multihead_attention_fprop_params params,
                                                      int const total_heads) {
  fused_multihead_attention::device_1xN<Kernel_traits, IS_TRAINING>(params, total_heads);
}

template <bool IS_TRAINING>
__global__ void fmha_fprop_v2_fp16_128_64_sm80_kernel_nl(
