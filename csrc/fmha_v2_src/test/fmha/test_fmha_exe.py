...
def test_fmha_flash_extended_fp16(
...
@pytest.mark.parametrize("fmha_arg", reduced2x_combinations_fp16())
def test_fmha_classic_extended_fp16(
    fmha_arg, rules, dryrun, disable_rules, gpu_compute_cap
):
    fmha_harness(
        fmha_exe_path, fmha_arg, rules, dryrun, gpu_compute_cap=gpu_compute_cap
...
def test_fmha_flash_extended_bf16(
    fmha_arg, rules, dryrun, disable_rules, gpu_compute_cap
):
    fmha_harness(
        fmha_exe_path, fmha_arg, rules, dryrun, gpu_compute_cap=gpu_compute_cap
...
@pytest.mark.parametrize("fmha_arg", reduced2x_combinations_bf16())
def test_fmha_classic_extended_bf16(
    fmha_arg, rules, dryrun, disable_rules, gpu_compute_cap
):
    fmha_harness(
        fmha_exe_path, fmha_arg, rules, dryrun, gpu_compute_cap=gpu_compute_cap
...
def test_fmha_int8_interleaved(fmha_arg, rules, dryrun, disable_rules, gpu_compute_cap):
    fmha_harness(
        fmha_exe_path, fmha_arg, rules, dryrun, gpu_compute_cap=gpu_compute_cap
    )
...
def test_fmha_fp16_bench(fmha_arg, rules, dryrun, disable_rules, gpu_compute_cap):
    fmha_harness(
        fmha_exe_path, fmha_arg, rules, dryrun, gpu_compute_cap=gpu_compute_cap
    )
...
def test_fmha_fp16_sd_bench(fmha_arg, rules, dryrun, disable_rules, gpu_compute_cap):
    fmha_harness(
        fmha_exe_path, fmha_arg, rules, dryrun, gpu_compute_cap=gpu_compute_cap
    )
