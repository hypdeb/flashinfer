...
using Kernel_traits_nl = fmha::Kernel_traits_v1<fmha::Volta_hmma_fp16_traits, 512, 32, 32, 1, 1 * 8,
                                                1, 0x08u | 0x200 /* no_loop flag */>;

static_assert(Kernel_traits_nl::CTAS_PER_HEAD == 1, "");

extern "C" __global__ void fmha_v1_fp16_512_32_sm70_kernel_nl(
    bert::Fused_multihead_attention_params_v1 params) {
  fused_multihead_attention::device_1xN_nl<Kernel_traits_nl>(params);
}

void run_fmha_v1_fp16_512_32_sm70_nl(bert::Fused_multihead_attention_params_v1 const& params,
                                     cudaStream_t stream) {
  ...
  fmha_v1_fp16_512_32_sm70_kernel_nl<<<grid, Kernel_traits_nl::THREADS,
