...
// void run_fmha_v2_fp16_128_64_sm80(Launch_params<Fused_multihead_attention_fprop_params>
// &launch_params, const bool configure); void
// run_fmha_v2_fp16_256_64_sm80(Launch_params<Fused_multihead_attention_fprop_params>
// &launch_params, const bool configure); void
// run_fmha_v2_fp16_384_64_sm80(Launch_params<Fused_multihead_attention_fprop_params>
// &launch_params, const bool configure); void
// run_fmha_v2_fp16_512_64_sm80(Launch_params<Fused_multihead_attention_fprop_params>
...
void fmha_run_noloop_reduce(void* out, void const* in, int const* cu_seqlens, int const hidden_size,
                            int const batch_size, int const total, int const num_chunks,
                            cudaStream_t stream);
...
void set_params(Fused_multihead_attention_fprop_params& params,
                // sizes
                size_t const b, size_t const s, size_t const h, size_t const d,
                size_t const total_s,
                // device pointers
                void* qkv_packed_d, void* cu_seqlens_d, void* o_packed_d, void* do_packed_d,
                void* s_d, void* softmax_lse_d, void* softmax_sum_d, void* dq_acc_d, void* seed_d,
                float p_dropout,
  ...
  params.o_stride_in_bytes =
      sequences_interleaved ? get_size_in_bytes(h * d * b, data_type)
...
std::vector<at::Tensor> mha_fwd(
    ...
    bool is_sequences_interleaved, bool is_causal, bool has_alibi,
    c10::optional<at::Generator> gen_) {
  auto props = at::cuda::getCurrentDeviceProperties();
  auto stream = at::cuda::getCurrentCUDAStream().stream();
  Launch_params<Fused_multihead_attention_fprop_params> launch_params(props, stream, is_training,
                                                                      is_causal, is_nl);
  ...
  TORCH_CHECK(head_size == 40 || head_size == 64 || head_size == 80 || head_size == 96 ||
              head_size == 128);
  ...
  if (is_bf16) {
    switch (head_size) {
      case 40:
        launcher = &run_fmha_v2_flash_attention_bf16_S_40_sm80;
        break;
      case 64:
        launcher = &run_fmha_v2_flash_attention_bf16_S_64_sm80;
        break;
      case 80:
        launcher = &run_fmha_v2_flash_attention_bf16_S_80_sm80;
        break;
      case 96:
        launcher = &run_fmha_v2_flash_attention_bf16_S_96_sm80;
        break;
      case 128:
        launcher = &run_fmha_v2_flash_attention_bf16_S_128_sm80;
        break;
      default:
    ...
    switch (head_size) {
      case 40:
        launcher = &run_fmha_v2_flash_attention_fp16_S_40_sm80;
        break;
      case 64:
        launcher = &run_fmha_v2_flash_attention_fp16_S_64_sm80;
        break;
      case 80:
        launcher = &run_fmha_v2_flash_attention_fp16_S_80_sm80;
        break;
      case 96:
        launcher = &run_fmha_v2_flash_attention_fp16_S_96_sm80;
        break;
      case 128:
        launcher = &run_fmha_v2_flash_attention_fp16_S_128_sm80;
        break;
      default:
        std::string const error_msg =
            "the d = " + std::to_string(head_size) + " kernel hasn't been generated!";
        TORCH_CHECK(false, error_msg);
        break;
    }
  }
  ...
  set_params(launch_params.params, batch_size, seq_len, num_heads, head_size, total, qkv.data_ptr(),
             ...
             nullptr,         // softmax_sum
             nullptr,         // dq_acc
             random_seeds.data_ptr(), p_dropout, is_sequences_interleaved, is_bf16, has_alibi,
             is_causal);
...
std::vector<at::Tensor> mha_bwd(
    at::Tensor const& d_out,  // total x num_heads, x head_size
    at::Tensor const& out,    // total x num_head, x hea_szie
    at::Tensor const& qkv,    // total x num_heads x 3 x head_size, total := \sum_{i=0}^{b} s_i
    // at::Tensor &softmax,           // b x h x s x s softmax and dmask - will be overwritten with
    // dP
    ...
    bool save_dp, bool is_sequences_interleaved, bool is_causal, bool has_alibi,
    c10::optional<at::Generator> gen_) {
  auto stream = at::cuda::getCurrentCUDAStream().stream();
  ...
  int const head_size = sizes[D_DIM];
  TORCH_CHECK(batch_size > 0);
  TORCH_CHECK(head_size == 64 || head_size == 40 || head_size == 128 || head_size == 80 ||
              head_size == 96);
  ...
  auto dq_acc =
      torch::empty({num_heads, total, Next_power_of_two(head_size)}, opts.dtype(at::kFloat));
  dq_acc.zero_();
  ...
  if (is_bf16) {
    switch (head_size) {
      case 40:
        launcher = &run_fmha_dgrad_v2_flash_attention_bf16_S_40_sm80;
        break;
      case 64:
        launcher = &run_fmha_dgrad_v2_flash_attention_bf16_S_64_sm80;
        break;
      case 80:
        launcher = &run_fmha_dgrad_v2_flash_attention_bf16_S_80_sm80;
        break;
      case 96:
        launcher = &run_fmha_dgrad_v2_flash_attention_bf16_S_96_sm80;
        break;
      case 128:
        launcher = &run_fmha_dgrad_v2_flash_attention_bf16_S_128_sm80;
        break;
      default:
        std::string const error_msg =
            "bf16, the d = " + std::to_string(head_size) + " kernel hasn't been generated!";
    ...
    switch (head_size) {
      case 40:
        launcher = &run_fmha_dgrad_v2_flash_attention_fp16_S_40_sm80;
        break;
      case 64:
        launcher = &run_fmha_dgrad_v2_flash_attention_fp16_S_64_sm80;
        break;
      case 80:
        launcher = &run_fmha_dgrad_v2_flash_attention_fp16_S_80_sm80;
        break;
      case 96:
        launcher = &run_fmha_dgrad_v2_flash_attention_fp16_S_96_sm80;
        break;
      case 128:
        launcher = &run_fmha_dgrad_v2_flash_attention_fp16_S_128_sm80;
        break;
      default:
        std::string const error_msg =
            "the d = " + std::to_string(head_size) + " kernel hasn't been generated!";
  ...
  if (save_dp) {
    ...
    set_params(params, batch_size, seq_len, num_heads, head_size, total, qkv.data_ptr(),
               cu_seqlens.data_ptr(),
               out.data_ptr(),      // o_ptr = out
               d_out.data_ptr(),    // do_ptr = d_out
               softmax.data_ptr(),  // softmax gets overwritten by dP!
               softmax_lse.data_ptr(), softmax_sum.data_ptr(), dq_acc.data_ptr(),
               random_seed.data_ptr(), p_dropout, is_sequences_interleaved, is_bf16, has_alibi,
               is_causal);
...
std::vector<at::Tensor> mha_bwd_noloop(
  ...
  fmha_run_noloop_reduce(dqkv.data_ptr(), dkv.data_ptr(), cu_seqlens.data_ptr<int>(), hidden_size,
                         batch_size, total, num_chunks, stream);
