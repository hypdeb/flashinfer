...
inline __device__ void device_flash_attention_(Params const& params, int const bidb, int const bidh,
...
#pragma unroll
            for (int ni = 0; ni < Mma_tile_p::MMAS_N; ni++) {
              ...
              uint16_t* rand_arr =
                  (uint16_t*)&ph(philox_subsequence + ni * Cta_tile_p::WARPS_N +
...
inline __device__ void device_flash_attention(Params const& params, int const num_full_heads,
